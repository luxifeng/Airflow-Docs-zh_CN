...
Airflow要求你在能运行任务之前先初始化数据库。如果你仅仅是为了实验和学习Airflow，那么你可以继续使用默认的SQLite。如果你不想使用SQLite，那么可以看看[初始化数据库后端](how-to-guides/how-to-guides.md#chu-shi-hua-shu-ju-ku-hou-duan)设置一个不同的数据库。
